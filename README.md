...
To gain access to our Coachbot-Swarm organization and start submitting experiments, email us at coachbotswarmsystem@gmail.com with your name, university, and github username associated with the account.

## Getting Familiar with the System through the Example Folder
After emailing us, you will receive an email (to the address linked to your Github username) inviting you to join the Coachbot-Swarm organization. Please allow up to one business day for this invitation from when you emailed us. Once you accept the invite to the organization, you'll get access to two repositories. The first of the repositories is named submission_repo, where you will be able to, as the name suggests, submit your experiments. Details on this process are outlined in sections below. The second is a private repository which has the same name as the Github username that was requested to be a collaborator to the platform. This repository is where you and any collaborators you choose to add can iterate on experiments, prep files for submission, and access results. This private repository contains template and example files for API calls, experiment submissions, etc. Further sections below walk through the files needed for submission and the available robot API functions.
